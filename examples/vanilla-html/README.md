...
> **Note:** The `transport` and `tus` options were removed from `useFileUpload`. Pipeline processing produces artifact blobs — you handle upload yourself (TUS, fetch, etc.) in the `onFileComplete` callback.
