...
| Benchmark                                           | Ops/sec       |
| --------------------------------------------------- | ------------- |
| isSupportedMediaUpload (video)                      | 10,659,408.70 |
| isSupportedMediaUpload (RAW octet-stream)           | 6,753,991.09  |
| isSupportedMediaUpload (reject)                     | 7,199,226.36  |
| isVideoLike + isAudioLike                           | 6,861,437.07  |
| shouldUploadWithoutTranscode + shouldCompressToJpeg | 4,313,174.96  |
| two-stage pipeline (async)                          | 47,236.48     |
