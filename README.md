...
| Benchmark                                       | Ops/sec       |
| ----------------------------------------------- | ------------- |
| video (MIME match)                              | 14,704,524.50 |
| RAW octet-stream (extension match)              | 10,593,647.81 |
| SVG (MIME match)                                | 13,747,478.41 |
| raster image (MIME match)                       | 13,578,546.13 |
| audio (MIME match)                              | 14,503,564.61 |
| reject (text/plain)                             | 16,294,281.32 |
| by MIME                                         | 9,517,007.90  |
| by extension                                    | 11,930,750.38 |
| false (image)                                   | 12,086,486.84 |
| by MIME                                         | 9,554,552.62  |
| by extension                                    | 11,078,673.05 |
| false (image)                                   | 13,207,658.71 |
| RAW extension — true                            | 2,475,007.37  |
| non-RAW extension — false                       | 15,294,371.97 |
| .heic extension — true                          | 11,858,050.27 |
| image/heif MIME — true                          | 9,080,693.67  |
| false (PNG)                                     | 9,881,478.60  |
| .tif extension — true                           | 10,454,408.10 |
| .tiff extension — true                          | 11,476,785.93 |
| image/tiff MIME — true                          | 9,773,791.47  |
| false (JPEG)                                    | 10,177,863.78 |
| video — true                                    | 9,317,404.49  |
| audio — true                                    | 9,639,052.48  |
| SVG — true                                      | 7,237,903.09  |
| raster PNG — false                              | 7,896,243.10  |
| RAW extension — true                            | 6,673,453.01  |
| raster PNG — true                               | 7,258,361.35  |
| SVG — false                                     | 6,999,494.87  |
| audio — false                                   | 9,102,470.49  |
| 7 async stages (like real pipeline)             | 128.89        |
| 7 stages with half skipped (when returns false) | 225.60        |
| stage error → onError fallback                  | 299.03        |
| stage error → onError skip                      | 303.16        |
